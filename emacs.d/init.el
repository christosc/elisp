...
;; Try fix ediff colors
;; (set-face-attribute 'ediff-current-diff-face-A nil :foreground "firebrick" :background "pale green")
;; (set-face-attribute 'ediff-current-diff-face-Ancestor nil :foreground "Black" :background "VioletRed")
;; (set-face-attribute 'ediff-current-diff-face-B nil :foreground "DarkOrchid" :background "Yellow")
;; (set-face-attribute 'ediff-current-diff-face-C nil :foreground "Navy" :background "Pink")
;; (set-face-attribute 'ediff-even-diff-face-A nil :foreground "Black" :background "light grey")
;; (set-face-attribute 'ediff-even-diff-face-Ancestor nil :foreground "White" :background "Grey")
;; (set-face-attribute 'ediff-even-diff-face-B nil :foreground "White" :background "Grey")
;; (set-face-attribute 'ediff-even-diff-face-C nil :foreground "Black" :background "light grey")
;; (set-face-attribute 'ediff-fine-diff-face-A nil :foreground "Navy" :background "sky blue")
;; (set-face-attribute 'ediff-fine-diff-face-Ancestor nil :foreground "Black" :background "Green")
;; (set-face-attribute 'ediff-fine-diff-face-B nil :foreground "Black" :background "cyan")
;; (set-face-attribute 'ediff-fine-diff-face-C nil :foreground "Black" :background "Turquoise")
;; (set-face-attribute 'ediff-odd-diff-face-A nil :foreground "White" :background "Grey")
;; (set-face-attribute 'ediff-odd-diff-face-Ancestor nil :foreground "Black" :background "light grey")
;; (set-face-attribute 'ediff-odd-diff-face-B nil :foreground "Black" :background "light grey")
...
(custom-set-faces
 ...
 '(ediff-even-diff-C ((t (:extend t :background "light grey" :foreground "black"))))
 ...
 '(ediff-odd-diff-A ((t (:extend t :background "Grey" :foreground "Black"))))
 '(ediff-odd-diff-Ancestor ((t (:extend t :background "light grey" :foreground "black"))))
...
;; ;; Your init file should contain only one such instance.
;; ;; If there is more than one, they won't work right.
;; '(ediff-current-diff-A ((t (:extend t :background "pale green" :foreground "firebrick"))))
;; '(ediff-current-diff-Ancestor ((t (:extend t :background "VioletRed" :foreground "black"))))
;; '(ediff-current-diff-B ((t (:extend t :background "Yellow" :foreground "DarkOrchid"))))
;; '(ediff-current-diff-C ((t (:extend t :background "Pink" :foreground "Navy"))))
